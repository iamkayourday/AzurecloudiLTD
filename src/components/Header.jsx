    ...
    <header className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white sticky top-0 z-50 shadow-lg">
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <motion.div
          ...
          className={`fixed top-0 right-0 w-3/4 h-full bg-gradient-to-b from-indigo-600 via-purple-600 to-pink-600 text-white p-6 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} lg:hidden shadow-xl`}
        >
